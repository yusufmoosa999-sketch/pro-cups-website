        ...
        <div className="min-h-screen bg-slate-100">
            ...
            <aside className="fixed inset-y-0 left-0 z-40 hidden w-72 flex-col bg-[#0b1120] text-white lg:flex">
                ...
                <nav className="flex-1 space-y-2 px-5 py-8">
                    ...
                    <Link
                        href="/portal"
                        className={`block rounded-xl px-4 py-3.5 font-semibold transition ${isActive("/portal")
                    ...
                    <Link
                        href="/portal/quotes"
                        className={`block rounded-xl px-4 py-3.5 font-semibold transition ${isActive("/portal/quotes")
                            ? "bg-green-600 text-white hover:bg-green-500"
                            : "text-slate-300 hover:bg-white/5 hover:text-white"
                            }`}
                    >
                    ...
                    <Link
                        href="/portal/orders"
                        className={`block rounded-xl px-4 py-3.5 font-semibold transition ${isActive("/portal/orders")
                            ? "bg-green-600 text-white hover:bg-green-500"
                            : "text-slate-300 hover:bg-white/5 hover:text-white"
                            }`}
                    >
                    ...
                    <Link
                        href="/portal/artwork"
                        className={`block rounded-xl px-4 py-3.5 font-semibold transition ${isActive("/portal/artwork")
                            ? "bg-green-600 text-white hover:bg-green-500"
                            : "text-slate-300 hover:bg-white/5 hover:text-white"
                            }`}
                    >
                    ...
                    <Link
                        ...
                        className={`block rounded-xl px-4 py-3.5 font-semibold transition ${isActive("/portal/invoices")
                            ? "bg-green-600 text-white hover:bg-green-500"
                            : "text-slate-300 hover:bg-white/5 hover:text-white"
                            }`}
                    >
                    ...
                    <Link
                        href="/portal/profile"
                        className={`block rounded-xl px-4 py-3.5 font-semibold transition ${isActive("/portal/profile")
                                ? "bg-green-600 text-white hover:bg-green-500"
                                : "text-slate-300 hover:bg-white/5 hover:text-white"
                            }`}
                    >
